...
if($_SERVER["REQUEST_METHOD"]=="POST"){
  ...
  if (isset( $_POST['username'])){
    ...
    $exitsts = FALSE;
  if(($pass_word==$cpass_word) && $exitsts == FALSE){
    $sql ="INSERT INTO `users` ( `username`, `password`, `dt`) VALUES ('$user_name', '$pass_word', current_timestamp());";
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form action="/curd/sign_up.php" method="post"class="form-inline my-2 my-lg-0">
        <button class="btn btn-danger my-2 mx-1 my-sm-0" type="submit">Sign Up</button>
      </form>
...
<!--FORM--> 
  <div class="container my-4">
     ...
     <form action="/curd/sign_up.php" method="post">
